      ...
      <div class="item-box">
        <div class="gallery-wrapper">
          <div class="gallery">
            <div class="thumbnail">
              <ul>
                <li @click="tableImg(index)" :class="{'on':index == imgIndex}" v-for="(item,index) in itemInfo.ali_images" :key="index">
                  <img :src="item+'?x-oss-process=image/resize,w_54/quality,Q_90/format,webp'"></li>
              </ul>
            </div>
            <div class="thumb">
              <ul>
                <li :class="{'on':index == imgIndex}" v-for="(item,index) in itemInfo.ali_images" :key="index">
                  <img :src="item+'?x-oss-process=image/resize,w_440/quality,Q_90/format,webp'"></li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div class="sku-dynamic-params clear">
              ...
              <ul class="params-colors">
                <li :class="{'cur':item.id == $route.query.itemId}" v-for="(item,index) in itemInfo.sku_list" :key="index">
                  <router-link :title="item.color" :to="{name:'Item',query:{itemId: item.id}}">
